const Header = () => {
    return (
        <div className="relative">
            <div className="circle-clip bg-[#7A3199] absolute left-0 top-0 h-full w-full -z-10">
                &nbsp;
            </div>
            <div className="lower-triangle bg-gradient-to-r from-[#4e1b63] to-[#161033] absolute bottom-0 left-0 h-full w-full -z-20">
                &nbsp;
            </div>
            <div className="upper-triangle bg-gradient-to-r from-[#753091] to-[#1e1643] absolute right-0 top-0 h-full w-full -z-10">
                &nbsp;
            </div>
            <div>
                <div className="nav flex text-white justify-between px-[175px] h-24 items-center">
                    <div>Logo</div>
                    <div>
                ...
                <div className="podcast flex justify-between text-white px-[175px] mt-10">
                    ...
                    <div className="right relative w-1/2">
                        <div className="h-[281px] w-[491px] absolute top-0 left-24">
                            <img
                                src="src\assets\everyone-is-smiling.png"
                                alt=""
                            />
                        </div>
